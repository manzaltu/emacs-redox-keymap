...
// Layered keymaps
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {[_MAIN]  = LAYOUT(KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, CW_TOGG, KC_Q, KC_W, KC_E, KC_R, KC_T, TG(_GAME), KC_PAUS, KC_Y, KC_U, KC_I, KC_O, KC_P, QK_LLCK, MO(_SYM), KC_A, KC_S, KC_D, KC_F, KC_G, KC_TAB, KC_DEL, KC_H, KC_J, KC_K, KC_L, KC_SCLN, MO(_SYM), KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_CAPS, KC_PSCR, KC_SCRL, KC_INS, KC_N, KC_M, KC_COMM, KC_DOT, KC_APP, KC_RSFT, KC_LALT, LCAG(KC_NO), MO(_NUM), KC_LGUI, KC_LCTL, KC_SPC, KC_BSPC, KC_ESC, KC_ENT, KC_RALT, RAG(KC_RCTL), TD(TD_NAV_MOUSE), KC_RGUI, KC_RCTL),
