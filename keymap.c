...
// Layered keymaps
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {[_MAIN]  = LAYOUT(KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, QK_LLCK, KC_Q, KC_W, KC_E, KC_R, KC_T, TG(_GAME), KC_SCRL, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_CAPS, MO(_SYM), KC_A, KC_S, KC_D, KC_F, KC_G, KC_TAB, KC_DEL, KC_H, KC_J, KC_K, KC_L, KC_SCLN, MO(_SYM), KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, CW_TOGG, KC_PSCR, KC_PAUS, KC_INS, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_LALT, LCAG(KC_NO), MO(_NUM), KC_LGUI, TD(TD_LCTL_NAV), KC_SPC, KC_BSPC, KC_ESC, KC_ENT, TD(TD_RALT_MOUSE), RAG(KC_RCTL), KC_APP, KC_RGUI, KC_RCTL),
                                                              ...
                                                              [_MOUSE] = LAYOUT(KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_NO, MOUSE_UP_LEFT, MS_UP, MOUSE_UP_RIGHT, KC_NO, MS_ACL0, KC_RALT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, MS_BTN3, KC_TRNS, MS_WHLU, MS_LEFT, KC_NO, MS_RGHT, MS_WHLL, MS_ACL1, KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, MS_WHLD, MOUSE_DOWN_LEFT, MS_DOWN, MOUSE_DOWN_RIGHT, MS_WHLR, MS_ACL2, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, MS_BTN1, MS_BTN2, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
