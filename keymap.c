...
#define ACTION_TAP_DANCE_LAYER_DOUBLE_HOLD(mod_kc, layer)                          \
    {                                                                              \
        .fn        = {NULL, td_double_hold_finished, td_double_hold_reset, NULL},  \
        .user_data = (void *)&((tap_dance_double_hold_t){mod_kc, layer, TD_NONE}), \
    }
...
tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_RALT_MOUSE] = ACTION_TAP_DANCE_LAYER_DOUBLE_HOLD(KC_RALT, _MOUSE),
    [TD_LCTL_NAV]   = ACTION_TAP_DANCE_LAYER_DOUBLE_HOLD(KC_LCTL, _NAV),
};
...
void td_double_hold_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (td_user_data->state) {
        case TD_SINGLE_TAP_OR_HOLD:
            register_mods(MOD_BIT(td_user_data->mod_kc));
            break;
        case TD_DOUBLE_TAP_OR_HOLD:
            layer_lock_off(td_user_data->layer); // Unlock the layer, in case it was locked
            layer_on(td_user_data->layer);
            break;
        default:
            break;
    }
...
void td_double_hold_reset(tap_dance_state_t *state, void *user_data) {
    ...
    switch (td_user_data->state) {
        case TD_SINGLE_TAP_OR_HOLD:
            unregister_mods(MOD_BIT(td_user_data->mod_kc));
            break;
        case TD_DOUBLE_TAP_OR_HOLD:
            // Make sure the layer is not locked before turning it off
            if (!is_layer_locked(td_user_data->layer)) {
                layer_off(td_user_data->layer);
            }
            break;
        default:
            break;
...
// Layered keymaps
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {[_MAIN]  = LAYOUT(KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, QK_LLCK, KC_Q, KC_W, KC_E, KC_R, KC_T, TG(_GAME), KC_SCRL, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_PAUS, MO(_SYM), KC_A, KC_S, KC_D, KC_F, KC_G, KC_TAB, KC_DEL, KC_H, KC_J, KC_K, KC_L, KC_SCLN, MO(_SYM), KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, CW_TOGG, KC_PSCR, KC_CAPS, KC_INS, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_LALT, LCAG(KC_NO), MO(_NUM), KC_LGUI, TD(TD_LCTL_NAV), KC_SPC, KC_BSPC, KC_ESC, KC_ENT, TD(TD_RALT_MOUSE), RAG(KC_RCTL), KC_APP, KC_RGUI, KC_RCTL),
                                                              [_SYM]   = LAYOUT(KC_F13, KC_F14, KC_F15, KC_F16, KC_F17, KC_F18, KC_F19, KC_F20, KC_F21, KC_F22, KC_F23, KC_F24, KC_TRNS, KC_TRNS, KC_BSLS, KC_PIPE, KC_TRNS, KC_TRNS, RGB_MOD, RGB_VAI, KC_TRNS, KC_TRNS, KC_LCBR, KC_RCBR, KC_TRNS, RGB_TOG, KC_TRNS, KC_EQL, KC_PLUS, KC_MINS, KC_UNDS, KC_TILD, RGB_RMOD, RGB_VAD, KC_GRV, KC_QUOT, KC_DQUO, KC_LPRN, KC_RPRN, KC_TRNS, KC_TRNS, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_SLEP, LCTL(KC_PSCR), RALT(KC_PAUS), RALT(KC_INS), KC_CIRC, KC_AMPR, KC_ASTR, KC_LBRC, KC_RBRC, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, LCTL(KC_SPC), LCTL(KC_BSPC), RALT(KC_ESC), RALT(KC_ENT), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
                                                              [_NUM]   = LAYOUT(KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_NO, KC_7, KC_8, KC_9, KC_COMM, KC_TRNS, KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_NO, KC_4, KC_5, KC_6, KC_DOT, KC_TRNS, KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_1, KC_2, KC_3, KC_0, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
                                                              ...
                                                              [_MOUSE] = LAYOUT(KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_NO, MOUSE_UP_LEFT, MS_UP, MOUSE_UP_RIGHT, KC_NO, MS_ACL0, KC_RALT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, MS_BTN3, KC_TRNS, MS_WHLL, MS_LEFT, MS_DOWN, MS_RGHT, MS_WHLU, MS_ACL1, KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, MS_WHLR, MOUSE_DOWN_LEFT, KC_NO, MOUSE_DOWN_RIGHT, MS_WHLD, MS_ACL2, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, MS_BTN1, MS_BTN2, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
